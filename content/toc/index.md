...
- Command Line Interface (CLI)
  ...
  - [Exporting Records]({{< relref "cli/export.md" >}})
  - [Deleting Records]({{< relref "cli/delete.md" >}})
  - [Setting attributes of a record]({{< relref "cli/set.md" >}})
  - [Getting attribute of a record]({{< relref "cli/get.md" >}})
  - [Editing a record]({{< relref "cli/edit.md" >}})
  - [Fetching records by record type]({{< relref "cli/query.md" >}})
